...
export default function fetchAnimais(url, target) {
  ...
  async function criarAnimais() {
    try {
      ...
      // apos a transformacao em Json ativa as funcoes para
      // preencher a animar os numeros
  ...
  return criarAnimais(); // quando ativar a funcao ( fetchAnimais ) ele vai ativar a  ( c )
}
